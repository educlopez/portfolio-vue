<template>
  <div>
    <vue-headful
      title="Edu Calvo - Recomendaciones"
      description="Recomendaciones de material, inspiraciones y equipo"
      keywords="Portfolio, Diseño, Front-End, Development"
      image="https://api.microlink.io?url=https%3A%2F%2Feducalvolopez.com&waitFor=10&overlay.browser=dark&overlay.background=%23fbb828&screenshot=true&meta=false&embed=screenshot.url"
      lang="es"
      url="https://www.educalvolopez.com/recomendaciones"
      ogTitle="Eduardo Calvo - Recomendaciones"
      ogURL="https://www.educalvolopez.com/recomendaciones"
      ogType="website"
      ogImage="https://api.microlink.io?url=https%3A%2F%2Feducalvolopez.com&waitFor=10&overlay.browser=dark&overlay.background=%23fbb828&screenshot=true&meta=false&embed=screenshot.url"
      ogDescription="Recomendaciones de material, inspiraciones y equipo"
      ogLocale="es_ES"
    ...
    />
     <Header header="Cookies" subheader=""/>
    <section class="section section-md panel" data-color="white">
      <div class="container">
        <div class="row">
            <div class="card">
              <div class="card-body">
               <p>
                ...
                <p>
                    Para poder ofrecerte una mejor experiencia de usuario, obtener datos analíticos, almacenar y recuperar información sobre tus hábitos de navegación o de tu equipo y desarrollar su actividad, este sitio web <a  href="https://educalvolopez.com" class="special-link__red" hreflang="es" rel="noopener" target="_blank">https://educalvolopez.com</a>, utiliza cookies propias y de terceros.
                    <br>
                    ...
                    <br>
                    <strong>Cookies de terceros:</strong> Esta web <a  href="https://educalvolopez.com" class="special-link__red" hreflang="es" rel="noopener" target="_blank">https://educalvolopez.com</a> puede utilizar servicios de terceros que, por cuenta de Google, recopilarán información con fines estadísticos, de uso del sitio por parte del usuario y para la prestación de otros servicios relacionados con la actividad del sitio web y otros servicios de Internet.
                    <br>
                ...
                <p>
                    ...
                    <br>
                    Google Chrome <a href="https://support.google.com/chrome/answer/95647?hl=es-419" class="special-link__red" hreflang="es" rel="noopener" target="_blank">https://support.google.com/chrome/answer/95647?hl=es-419</a>
                    <br>
                    Internet Explorer <a href="https://support.microsoft.com/es-es/help/17442/windows-internet-explorer-delete-manage-cookies#ie=ie-10" class="special-link__red" hreflang="es" rel="noopener" target="_blank">https://support.microsoft.com/es-es/help/17442/windows-internet-explorer-delete-manage-cookies#ie=ie-10</a>
                    <br>
                    Mozilla Firefox <a href="https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-sitios-web-rastrear-preferencias?redirectlocale=es&redirectslug=habilitar-y-deshabilitar-cookies-que-los-sitios-we" class="special-link__red" hreflang="es" rel="noopener" target="_blank">https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-sitios-web-rastrear-preferencias?redirectlocale=es&redirectslug=habilitar-y-deshabilitar-cookies-que-los-sitios-we</a>
                    <br>
                    Apple Safari <a href="https://support.apple.com/es-es/HT201265" class="special-link__red" hreflang="es" rel="noopener" target="_blank">https://support.apple.com/es-es/HT201265</a>
                    <br>
                    Si tienes cualquier duda sobre esta Política de Cookies, puedes contactar con nosotros enviándonos un mail a <a href="mailto:educlopez93@gmail.com" class="special-link__red" hreflang="es" rel="noopener">educlopez93@gmail.com</a>.
                </p>
              </div>
          </div>
        </div>
