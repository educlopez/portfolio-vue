<template>
  <div>
    ...
    />
     <Header header="Política de privacidad y Aviso Legal" subheader=""/>
    <section class="section section-md panel" data-color="white">
      <div class="container">
        <div class="row">
            <div class="card">
              <div class="card-body">
              <p>Fecha efectiva: November 10, 2019</p>

              <p>Edu Calvo Design ("nosotros", "a nosotros", "nuestro") opera el sitio web https://educalvolopez.com (en adelante, el "Servicio").</p>

              <p>Esta página le informa de nuestras políticas en materia de recopilación, uso y divulgación de datos personales cuando utiliza nuestro Servicio y de las opciones de las que dispone en relación con esos datos. The Privacy Policy  for Edu Calvo Design has been created with the help of <a href="https://termsfeed.com/privacy-policy-generator/">TermsFeed Privacy Policy Generator</a>.</p>

              <p>Utilizamos sus datos para prestarle el Servicio y mejorarlo. Al utilizar el Servicio, usted acepta la recopilación y el uso de información de conformidad con esta política. A menos que esta Política de privacidad defina lo contrario, los términos utilizados en ella tienen los mismos significados que nuestros Términos y Condiciones, disponibles en el https://educalvolopez.com</p>

              <h2>Definiciones</h2>
              <ul>
                  <li>
                      <p><strong>Servicio</strong></p>
                              <p>Servicio es el sitio web https://educalvolopez.com operado por Edu Calvo Design</p>
                          </li>
                  <li>
              ...
              <h2>Uso de datos</h2>
              <p>Edu Calvo Design utiliza los datos recopilados con diversas finalidades:</p>
              <ul>
              ...
              <p>Como ciudadano europeo, bajo GDPR, tiene ciertos derechos individuales. Puede obtener más información sobre estos derechos en <a href="https://termsfeed.com/blog/gdpr/#Individual_Rights_Under_the_GDPR">la guía GDPR</a>.</p>
              ...
              <ul>
                      <li>Por e-mail: educlopez93@gmail.com</li>
