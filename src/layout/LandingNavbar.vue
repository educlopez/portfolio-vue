            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-xl">
                <div class="dropdown-menu-inner">
                  ...
                  >
                    <div
                      class="icon icon-shape bg-gradient-primary rounded-circle"
                    >
                    ...
                    <div class="media-body ml-3">
                      ...
                      <p class="description d-none d-md-inline-block mb-0"
                        >Creación del diseño y desarrollo de su página web</p
                      >
                    </div>
                  </router-link>
                  <router-link
                    :to="{ path: '/services', hash: '#ServDesign' }"
                    class="media d-flex align-items-center"
                  >
                    <div
                      class="icon icon-shape bg-gradient-primary rounded-circle"
                    ...
                    <div class="media-body ml-3">
                      <h5 class="heading text-primary mb-md-1"
                        >Diseño Gráfico</h5
                      >
                      <p class="description d-none d-md-inline-block mb-0"
                        >Logotipos, redes sociales, diseños webs y mucho más</p
                      >
                    </div>
                  </router-link>
                  <router-link
                  ...
                  >
                    ...
                    <div class="media-body ml-3">
                      ...
                      <p class="description d-none d-md-inline-block mb-0"
                        >Cierre sus oportunidades de venta y servicio al cliente
                        con Newsletters</p
                      >
                    </div>
                  </router-link>
          ...
          <ul class="navbar-nav align-items-lg-center ml-lg-auto">
            ...
            <li class="nav-item">
              <a
                rel="noopener"
                class="nav-link nav-link-icon"
                href="https://www.linkedin.com/in/educlopez/"
                target="_blank"
                data-toggle="tooltip"
